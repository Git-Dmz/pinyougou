...
public class ItemCatController {
	...
	@RequestMapping("findParentId/{pageNum}/{pageSize}/{id}")
	public PageResult findParentId(@PathVariable("pageNum") int pageNum,@PathVariable("pageSize") int pageSize ,@PathVariable("id") Long id ){
		return itemCatService.findParentId(pageNum,pageSize,id);
	}
